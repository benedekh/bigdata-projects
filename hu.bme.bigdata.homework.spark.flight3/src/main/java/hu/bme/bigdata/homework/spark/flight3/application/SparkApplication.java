...
import hu.bme.bigdata.homework.spark.flight3.application.jopt.ParameterManager;
...
public class SparkApplication {
    ...
    public static final void main(String[] args) {
        try {
            ...
            tm.calculateAvgDelays(ctx, parameters.getFlightData(), parameters.getPartitions());
            ctx.stop();
        } catch (Exception ex) {
